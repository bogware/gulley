...
**Delivered (pulled forward, in progress):**
...
- _Still open in M11: inbound JWT/OIDC/Basic auth; P2C least-load; session affinity (HRW); hold-then-flush streaming block; managed guardrail plugins; PII depth._
